 ...
 *
 *  V01.002 30-Jun-2018 Jonathan D. Belanger
 *  Cleaned up some of the code after a reformatting error.  This'll make it
 *  easier to read.
 */
#include "CommonUtilities/AXP_DumpsDefs.h"
...
const char *jmpCmd[] = {"JMP", "JSR", "RET", "JSR_COROUTINE"};
 ...
 *      a value of 0 and a NULLpointer.
 *   funcVal:
 ...
 *  None.
 */
void AXP_Decode_Instruction(AXP_PC *pcAddr,
                            AXP_INS_FMT instr,
                            bool kernelMode,
                            char *instrStr)
{
 ...
 *  None.
 */
void AXP_Dump_Registers(AXP_INSTRUCTION *instr,
                        AXP_REGISTERS *pr,
                        AXP_REGISTERS *pf,
                        char *regStr)
{
     ...
     */
    else if (instr->decodedReg.bits.src2
             != 0)
    {
        sprintf(regStr,
                Regv,
