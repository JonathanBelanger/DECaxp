 ...
 * Local Prototypes
 */
static void AXP_21274_ReadPCSR(AXP_21274_PCHIP *, AXP_21274_CAPBUS_MSG *);
static void AXP_21274_WritePCSR(AXP_21274_PCHIP *, AXP_21274_CAPBUS_MSG *);
 ...
 */
static u64 AXP_21274_ReadPCSR(AXP_21274_PCHIP *p, AXP_21274_CAPBUS_MSG *msg)
{
	u64			retVal = 0;
 ...
 */
static void AXP_21274_WritePCSR(AXP_21274_PCHIP *p, AXP_21274_CAPBUS_MSG *msg)
{
	CSR_MAP				csrValue;
...
void *AXP_21274_PchipMain(void *voidPtr)
{
	...
	while (true)
	{
		 ...
		 */
		msg = (AXP_21274_CAPBUS_MSG *) p->tpr.flink;
		...
		{
			case PCIIackCycle:
			case PCISpecialCycle:
			case PCIIORead:
			case PCIIOWrite:
			case PCIMemoryWritePTP:
			case PCIMemoryRead:
			case PCIMemoryWriteCPU:
				break;
			...
			case PCIConfigurationRead:
			case PCIConfigurationWrite:
			case LoadPADbusDataDownstream:
			case PchipUpstreamLoadP:
			case CAPbusNoOp:
			case DMAReadNQw:
			case SGTEReadNQw:
			case PTPMemoryRead:
			...
			case DMARMWQw:
			case DMAWriteNQW:
			case CchipDownstreamLoadP:
			case LoadPADbusDataUpstream:
			case PTPWriteByteMaskBypass:
				break;
		}
