...
AXP_EXCEPTIONS AXP_CMPULT(AXP_21264_CPU *, AXP_INSTRUCTION *);
AXP_EXCEPTIONS AXP_CTLZ(AXP_21264_CPU *, AXP_INSTRUCTION *);
AXP_EXCEPTIONS AXP_CTPOP(AXP_21264_CPU *, AXP_INSTRUCTION *);
...
AXP_EXCEPTIONS AXP_UNPKBL(AXP_21264_CPU *, AXP_INSTRUCTION *);
AXP_EXCEPTIONS AXP_UNPKBW(AXP_21264_CPU *, AXP_INSTRUCTION *);

/*
 * PAL Functions
 */
AXP_EXCEPTIONS AXP_HWLD(AXP_21264_CPU *, AXP_INSTRUCTION *);
AXP_EXCEPTIONS AXP_HWST(AXP_21264_CPU *, AXP_INSTRUCTION *);
AXP_EXCEPTIONS AXP_HWRET(AXP_21264_CPU *, AXP_INSTRUCTION *);
AXP_EXCEPTIONS AXP_HWMTPR(AXP_21264_CPU *, AXP_INSTRUCTION *);
AXP_EXCEPTIONS AXP_HWMFPR(AXP_21264_CPU *, AXP_INSTRUCTION *);
