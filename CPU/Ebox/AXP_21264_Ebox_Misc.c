 ...
 *  instructions are just place-holders until the Data Cache functionality
...
#include "CPU/Ebox/AXP_21264_Ebox_Misc.h"
 ...
 *
 *  NOTE:   There is only one implementation of these instructions (not one for
 ...
 */
AXP_EXCEPTIONS
AXP_AMASK(AXP_21264_CPU *cpu, AXP_INSTRUCTION *instr)
{
 ...
 */
AXP_EXCEPTIONS
AXP_CALL_PAL(AXP_21264_CPU *cpu, AXP_INSTRUCTION *instr)
{
 ...
 */
AXP_EXCEPTIONS
AXP_IMPLVER(AXP_21264_CPU *cpu, AXP_INSTRUCTION *instr)
{
 ...
 */
AXP_EXCEPTIONS
AXP_ECB(AXP_21264_CPU *cpu, AXP_INSTRUCTION *instr)
{
 ...
 */
AXP_EXCEPTIONS
AXP_EXCB(AXP_21264_CPU *cpu, AXP_INSTRUCTION *instr)
{
 ...
 */
AXP_EXCEPTIONS
AXP_FETCH(AXP_21264_CPU *cpu, AXP_INSTRUCTION *instr)
{
 ...
 */
AXP_EXCEPTIONS
AXP_FETCH_M(AXP_21264_CPU *cpu, AXP_INSTRUCTION *instr)
{
 ...
 */
AXP_EXCEPTIONS
AXP_MB(AXP_21264_CPU *cpu, AXP_INSTRUCTION *instr)
{
 ...
 */
AXP_EXCEPTIONS
AXP_RPCC(AXP_21264_CPU *cpu, AXP_INSTRUCTION *instr)
{
 ...
 */
AXP_EXCEPTIONS
AXP_TRAPB(AXP_21264_CPU *cpu, AXP_INSTRUCTION *instr)
{
 ...
 */
AXP_EXCEPTIONS
AXP_WH64(AXP_21264_CPU *cpu, AXP_INSTRUCTION *instr)
{
 ...
 */
AXP_EXCEPTIONS
AXP_WH64EN(AXP_21264_CPU *cpu, AXP_INSTRUCTION *instr)
{
 ...
 */
AXP_EXCEPTIONS
AXP_WMB(AXP_21264_CPU *cpu, AXP_INSTRUCTION *instr)
{
