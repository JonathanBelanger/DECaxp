 ...
 *  Did some code clean-up and reformatting.
 */
...
AXP_Test_SM SM_Opt_Tests[] =
{
     ...
     */
    {AXP_OPT_NO,            YES_CLI_PREF,   AXP_OPT_WANTYES_SRV,    DO_SENT},
     ...
     * Current State        Action          ResultantState          ActionMask
     */
    {AXP_OPT_NO,            NO_CLI_PREF,    AXP_OPT_NO,             NO_ACTION},
     ...
     * Current State        Action          ResultantState          ActionMask
     */
    {AXP_OPT_NO,            YES_SRV_PREF,   AXP_OPT_WANTYES_SRV,    WILL_SENT},
     ...
     * Current State        Action          ResultantState          ActionMask
     */
    {AXP_OPT_NO,            NO_SRV_PREF,    AXP_OPT_NO,             NO_ACTION},
     ...
     * Current State        Action          ResultantState          ActionMask
     */
    {AXP_OPT_NO,            WILL_PREF,      AXP_OPT_YES,            DO_SENT},
     ...
     * Current State        Action          ResultantState          ActionMask
     */
    {AXP_OPT_NO,            WONT_PREF,      AXP_OPT_NO,             NO_ACTION},
     ...
     * Current State        Action          ResultantState          ActionMask
     */
    {AXP_OPT_NO,            DO_PREF,        AXP_OPT_YES,            WILL_SENT},
     ...
     * Current State        Action          ResultantState          ActionMask
     */
    {AXP_OPT_NO,            DONT_PREF,      AXP_OPT_NO,             NO_ACTION},
...
AXP_Test_SM SM_Rcv_Tests[] =
{
     ...
     * Current State        Action              ResultantState      ActionMask
     */
    {AXP_RCV_DATA,          AXP_ACT_NUL,        AXP_RCV_DATA,       ECHO_DATA},
     ...
     * Current State        Action              ResultantState      ActionMask
     */
    {AXP_RCV_IAC,           AXP_ACT_NUL,        AXP_RCV_DATA,       NO_ACTION},
     ...
     * Current State        Action              ResultantState      ActionMask
     */
    {AXP_RCV_CMD,           AXP_ACT_NUL,        AXP_RCV_DATA,       PROC_CMD},
     ...
     * Current State        Action              ResultantState      ActionMask
     */
    {AXP_RCV_CR,            AXP_ACT_NUL,        AXP_RCV_DATA,       NO_ACTION},
     ...
     * Current State        Action              ResultantState      ActionMask
     */
    {AXP_RCV_SB,            AXP_ACT_NUL,        AXP_RCV_SB,         SUBOPT_ACCUM},
     ...
     * Current State        Action              ResultantState      ActionMask
     */
    {AXP_RCV_SE,            AXP_ACT_NUL,        AXP_RCV_IAC,        CVT_PROC_IAC},
...
bool test_options_StateMachine(void)
{
    ...
    {
        printf("...Executing Option State Machine Test %3d for [%d]="
        ...
        testActionMask = 0;
        nextState = AXP_Execute_SM(sm,
                                   SM_Opt_Tests[ii].action,
                                   SM_Opt_Tests[ii].currentState,
                                   NULL);
        printf(" got {x,x, nextState: %d, action: 0x%04x}...\n",
               nextState,
               testActionMask);
    ...
    if (retVal == true)
    {
        ...
        /*
         * Now we can run our tests.  Loop through the test cases, execute the
         * state machine and determine if what occurred is what was expected
         * (as far as state transitions and action routines called).
         */
        ii = 0;
        while ((SM_Rcv_Tests[ii].currentState < AXP_RCV_MAX_STATE) && (retVal == true))
        {
            printf("...Executing Receive State Machine Test %3d for [%d]="
                   "{curState: %d, action: %d, nextState: %d, action: 0x%04x}...",
                   kk++,
                   ii,
