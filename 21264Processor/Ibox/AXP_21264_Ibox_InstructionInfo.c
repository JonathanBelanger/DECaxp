...
}, /* 00	CALL_PAL	Trap to PALcode				*/
{
Res, Other,
{
.raw = 0
}, AXP_NONE, PipelineNone
}, /* 01				Reserved for Digital		*/
{
Res, Other,
{
.raw = 0
}, AXP_NONE, PipelineNone
}, /* 02				Reserved for Digital		*/
{
Res, Other,
{
.raw = 0
}, AXP_NONE, PipelineNone
}, /* 03				Reserved for Digital		*/
{
Res, Other,
{
.raw = 0
}, AXP_NONE, PipelineNone
}, /* 04				Reserved for Digital		*/
{
Res, Other,
{
.raw = 0
}, AXP_NONE, PipelineNone
}, /* 05				Reserved for Digital		*/
{
Res, Other,
{
.raw = 0
}, AXP_NONE, PipelineNone
}, /* 06				Reserved for Digital		*/
{
Res, Other,
{
.raw = 0
}, AXP_NONE, PipelineNone
}, /* 07				Reserved for Digital		*/
{
Mem, Load,
{
.raw = AXP_DEST_RA | AXP_SRC1_RB
}, AXP_IQ, EboxL0L1U0U1
}, /* 08	LDA			Load address				*/
{
Mem, Load,
...
}, /* 09	LDAH		Load address high			*/
{
Mem, Load,
{
.raw = AXP_DEST_RA | AXP_SRC1_RB
}, AXP_IQ, EboxL0L1
}, /* 0A	LDBU		Load zero-extended byte		*/
{
Mem, Load,
{
.raw = AXP_DEST_RA | AXP_SRC1_RB
}, AXP_IQ, EboxL0L1
}, /* 0B	LDQ_U		Load unaligned quadword		*/
{
Mem, Load,
{
.raw = AXP_DEST_RA | AXP_SRC1_RB
}, AXP_IQ, EboxL0L1
}, /* 0C	LDWU		Load zero-extended word		*/
{
Mem, Store,
{
.raw = AXP_SRC1_RA | AXP_SRC2_RB
}, AXP_IQ, EboxL0L1
}, /* 0D	STW			Store word					*/
{
Mem, Store,
...
}, /* 0F	STQ_U		Store unaligned quadword	*/
{
Opr, Other,
{
.raw = AXP_DEST_RC | AXP_SRC1_RA | AXP_SRC2_RB
}, AXP_IQ, EboxL0L1U0U1
},/*10 ADDL	Add longword				*/
{
Opr, Other,
{
.raw = AXP_OPCODE_11
...
},/*12	MSKBL	Mask byte low				*/
{
Opr, Oper,
{
.raw = AXP_DEST_RC | AXP_SRC1_RA | AXP_SRC2_RB
}, AXP_IQ, EboxU1
},/*13	MULL		Multiply longword			*/
{
FP, Arith,
{
.raw = AXP_OPCODE_14
}, AXP_COND, EboxL0L1
}, /* 14	ITOFS		Int to float move, S_float	*/
{
FP, Other,
{
.raw = AXP_OPCODE_15
}, AXP_FQ, FboxOther
}, /* 15	ADDF		Add F_floating				*/
{
FP, Other,
{
.raw = AXP_OPCODE_16
}, AXP_FQ, FboxOther
}, /* 16	ADDS		Add S_floating				*/
{
FP, Other,
{
.raw = AXP_OPCODE_17
}, AXP_FQ, EboxL0L1U0U1
}, /* 17	CVTLQ		Convert longword to quad	*/
{
Mfc, Other,
{
.raw = AXP_OPCODE_18
}, AXP_IQ, PipelineNone
}, /* 18	TRAPB		Trap barrier				*/
{
PAL, Load,
{
.raw = AXP_DEST_RA
}, AXP_IQ, EboxL0L1
}, /* 19	HW_MFPR		Reserved for PALcode		*/
{
Mbr, Branch,
{
.raw = AXP_DEST_RA | AXP_SRC1_RB
...
}, /* 1B	HW_LD		Reserved for PALcode		*/
{
Cond, Arith,
{
.raw = AXP_OPCODE_1C
}, AXP_COND, EboxL0L1U0U1
}, /* 1C	SEXTB		Sign extend byte			*/
{
PAL, Store,
{
.raw = AXP_SRC1_RB
}, AXP_IQ, EboxL0L1
}, /* 1D	HW_MTPR		Reserved for PALcode		*/
{
PAL, Branch,
{
.raw = AXP_SRC1_RB
}, AXP_IQ, EboxL0
}, /* 1E	HW_RET		Reserved for PALcode		*/
{
PAL, Store,
{
.raw = AXP_SRC1_RA | AXP_SRC2_RB
}, AXP_IQ, EboxL0L1
}, /* 1F	HW_ST		Reserved for PALcode		*/
{
Mem, Load,
{
.raw = AXP_DEST_FA | AXP_SRC1_RB
}, AXP_IQ, FboxOther
}, /* 20 	LDF			Load F_floating				*/
{
Mem, Load,
{
.raw = AXP_DEST_FA | AXP_SRC1_RB
}, AXP_IQ, FboxOther
}, /* 21	LDG			Load G_floating				*/
{
Mem, Load,
{
.raw = AXP_DEST_FA | AXP_SRC1_RB
}, AXP_IQ, FboxOther
}, /* 22	LDS			Load S_floating				*/
{
Mem, Load,
{
.raw = AXP_DEST_FA | AXP_SRC1_RB
}, AXP_IQ, FboxOther
}, /* 23	LDT			Load T_floating				*/
{
Mem, Store,
{
.raw = AXP_SRC1_FA | AXP_SRC2_RB
}, AXP_FQ, FboxOther
}, /* 24	STF			Store F_floating			*/
{
Mem, Store,
{
.raw = AXP_SRC1_FA | AXP_SRC2_RB
}, AXP_FQ, FboxOther
}, /* 25	STG			Store G_floating			*/
{
Mem, Store,
{
.raw = AXP_SRC1_FA | AXP_SRC2_RB
}, AXP_FQ, FboxOther
}, /* 26	STS			Store S_floating			*/
{
Mem, Store,
{
.raw = AXP_SRC1_FA | AXP_SRC2_RB
}, AXP_FQ, FboxOther
}, /* 27	STT			Store T_floating			*/
{
Mem, Load,
{
.raw = AXP_DEST_RA | AXP_SRC1_RB
}, AXP_IQ, EboxL0L1
}, /* 28	LDL			Load sign-extended long		*/
{
Mem, Load,
{
.raw = AXP_DEST_RA | AXP_SRC1_RB
}, AXP_IQ, EboxL0L1
}, /* 29	LDQ			Load quadword				*/
{
Mem, Load,
{
.raw = AXP_DEST_RA | AXP_SRC1_RB
}, AXP_IQ, EboxL0L1
}, /* 2A	LDL_L		Load sign-extend long lock	*/
{
Mem, Load,
{
.raw = AXP_DEST_RA | AXP_SRC1_RB
}, AXP_IQ, EboxL0L1
}, /* 2B	LDQ_L		Load quadword locked		*/
{
Mem, Store,
{
.raw = AXP_SRC1_RA | AXP_SRC2_RB
}, AXP_IQ, EboxL0L1
}, /* 2C	STL			Store longword				*/
{
Mem, Store,
{
.raw = AXP_SRC1_RA | AXP_SRC2_RB
}, AXP_IQ, EboxL0L1
}, /* 2D	STQ			Store quadword				*/
{
Mem, Store,
{
.raw = AXP_SRC1_RA | AXP_SRC2_RB
}, AXP_IQ, EboxL0L1
}, /* 2E	STL_C		Store longword conditional	*/
{
Mem, Store,
{
.raw = AXP_SRC1_RA | AXP_SRC2_RB
}, AXP_IQ, EboxL0L1
}, /* 2F	STQ_C		Store quadword conditional	*/
{
Bra, Branch,
{
.raw = AXP_DEST_RA
}, AXP_IQ, EboxL0
}, /* 30	BR			Unconditional branch		*/
{
FPBra, Branch,
{
.raw = AXP_SRC1_FA
}, AXP_FQ, FboxOther
}, /* 31	FBEQ		Floating branch if = zero	*/
{
FPBra, Branch,
{
.raw = AXP_SRC1_FA
}, AXP_FQ, FboxOther
}, /* 32	FBLT		Floating branch if < zero	*/
{
FPBra, Branch,
{
.raw = AXP_SRC1_FA
}, AXP_FQ, FboxOther
}, /* 33	FBLE		Floating branch if <= zero	*/
{
Mbr, Branch,
{
.raw = AXP_DEST_RA
}, AXP_IQ, EboxL0
}, /* 34	BSR			Branch to subroutine		*/
{
FPBra, Branch,
{
.raw = AXP_SRC1_FA
}, AXP_FQ, FboxOther
}, /* 35	FBNE		Floating branch if != zero	*/
{
FPBra, Branch,
{
.raw = AXP_SRC1_FA
}, AXP_FQ, FboxOther
}, /* 36	FBGE		Floating branch if >=zero	*/
{
FPBra, Branch,
{
.raw = AXP_SRC1_FA
}, AXP_FQ, FboxOther
}, /* 37	FBGT		Floating branch if > zero	*/
{
Bra, Branch,
{
.raw = AXP_SRC1_RA
}, AXP_IQ, EboxL0
}, /* 38	BLBC		Branch if low bit clear		*/
{
Bra, Branch,
{
.raw = AXP_SRC1_RA
}, AXP_IQ, EboxL0
}, /* 39	BEQ			Branch if = zero			*/
{
Bra, Branch,
{
.raw = AXP_SRC1_RA
}, AXP_IQ, EboxL0
}, /* 3A	BLT			Branch if < zero			*/
{
Bra, Branch,
{
.raw = AXP_SRC1_RA
}, AXP_IQ, EboxL0
}, /* 3B	BLE			Branch if <= zero			*/
{
Bra, Branch,
{
.raw = AXP_SRC1_RA
}, AXP_IQ, EboxL0
}, /* 3C	BLBS		Branch if low bit set		*/
{
Bra, Branch,
{
.raw = AXP_SRC1_RA
}, AXP_IQ, EboxL0
}, /* 3D	BNE			Branch if != zero			*/
{
Bra, Branch,
{
.raw = AXP_SRC1_RA
}, AXP_IQ, EboxL0
}, /* 3E	BGE			Branch if >= zero			*/
{
Bra, Branch,
{
.raw = AXP_SRC1_RA
}, AXP_IQ, EboxL0
} /* 3F	BGT			Branch if > zero			*/
};
